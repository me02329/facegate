...
use app::{App, ConfigureExit, Focus, Mode};
use facegate_core::config::Config;

pub fn run_configure(config: Config, config_path: std::path::PathBuf) -> Result<ConfigureExit> {
    enable_raw_mode()?;
...
fn handle_key(app: &mut App, code: KeyCode) {
    match app.mode {
        ...
        Mode::Normal => match code {
            KeyCode::Esc => app.exit = Some(ConfigureExit::Back),
            KeyCode::Char('q') => app.exit = Some(ConfigureExit::Quit),
