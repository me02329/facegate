...
pub const DEFAULT_CONFIG_PATH: &str = "/etc/face-rs/config.toml";
...
impl Default for Config {
    fn default() -> Self {
        Config {
            ...
            models: ModelsConfig {
                detector: PathBuf::from("/usr/share/face-rs/models/scrfd_500m.onnx"),
                embedder: PathBuf::from("/usr/share/face-rs/models/arcface.onnx"),
            },
            storage: StorageConfig {
                base_dir: PathBuf::from("/var/lib/face-rs/users"),
            },
