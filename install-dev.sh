...
echo "  4. Broker reachable: sudo facegate status"
echo "  5. Enroll your face: sudo facegate add \$USER --for both"
echo "  6. Test:             sudo facegate test \$USER"
echo "  7. Enable screen-lock daemon (as your normal user):"
